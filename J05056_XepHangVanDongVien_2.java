    ...
    public static void main(String[] args) throws ParseException {
        ...
        Collections.sort(list, new Comparator<ThiSinh>() {
            ...
            public int compare(ThiSinh o1, ThiSinh o2) {
                try {
                    if (o1.getThanhTich().getTime() > o2.getThanhTich().getTime()) return 1;
                    if (o1.getThanhTich().getTime() == o2.getThanhTich().getTime()) return 0;
                    return -1;
                } catch (ParseException e) {
                    throw new RuntimeException(e);
                }
        ...
        Arrays.sort(ts, new Comparator<ThiSinh>() {
            ...
            public int compare(ThiSinh o1, ThiSinh o2) {
                ...
                if (o1.getXepHang() == o2.getXepHang()) return 0;
                return -1;
            }
        });
        for (int i = 0; i < n; i++) {
